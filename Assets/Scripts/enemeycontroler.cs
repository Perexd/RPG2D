...
public class enemeycontroler : MonoBehaviour
{
    ...
    [Tooltip("If enemy movement is not random, enemyDirections needs tohave at least two elements")]
    [SerializeField] private bool hasRandomMove;
    [Tooltip("Directions the enemy will follow to complete a path. Theidea is that it should be cyclical.Components must be - 1, 0 or 1")]
    ...
    private void Start()
    {
        ...
        directionToMove = hasRandomMove ? directionToMove = new Vector2(
